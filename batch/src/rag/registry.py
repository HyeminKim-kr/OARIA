"""Batch RAG 컴포넌트 레지스트리

Strategy Pattern + Registry Pattern으로 인덱싱 컴포넌트들을 관리합니다.
각 컴포넌트는 @register_* 데코레이터로 자동 등록됩니다.

사용 예시:
    from src.rag.registry import register_chunker, get_chunker
    ...
    chunker = get_chunker("my_chunker_v1")
"""
...
def _get_component(
    ...
    **kwargs,
    ...
    Args:
        component_type: 컴포넌트 타입 (chunker, embedder)
        name: 등록된 이름
