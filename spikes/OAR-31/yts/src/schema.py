...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Weaviate PaperChunk 스키마 관리")
    parser.add_argument("action", choices=["create", "delete", "info"],
                        help="수행할 작업")
    parser.add_argument("--host", default="localhost", help="Weaviate 호스트")
    parser.add_argument("--port", type=int, default=8080, help="Weaviate 포트")
    ...
    try:
        if args.action == "create":
            ...
            delete_paper_chunk_collection(client)
