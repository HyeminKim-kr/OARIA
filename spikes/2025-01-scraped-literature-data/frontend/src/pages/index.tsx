    ...
    <Layout title="Dashboard" subtitle="OARIA Literature Data System Overview">
      ...
      <div className="card" style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <Link href="/etl">
            <button className="btn btn-primary">🚀 ETL Worker</button>
          </Link>
          <Link href="/dashboard">
            <button className="btn btn-secondary">📊 Manage Papers</button>
          </Link>
          <Link href="/evidence">
        ...
        {recentPapers.length === 0 ? (
          <div className="empty-state">
            ...
            <div className="empty-state-description">
              Start by running an <Link href="/etl" style={{ color: 'var(--accent-green)' }}>ETL job</Link> to collect papers from PubMed.
            </div>
          </div>
        ) : (
