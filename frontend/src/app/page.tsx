    ...
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[var(--background)]/80 backdrop-blur-md border-b border-[var(--oaria-border)]">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          {/* CTA */}
          <button className="bg-[var(--oaria-teal)] hover:bg-[var(--oaria-light-teal)] text-white font-[family-name:var(--font-dm-sans)] text-sm font-medium px-5 py-2.5 rounded-full transition-colors">
            Get Started
          </button>
        </div>
      </header>
