...
export default function NodeDetailPanel({
  ...
  return (
    <div
      className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 rounded-xl overflow-hidden transition-all duration-300"
      style={{
        background: "rgba(10, 14, 26, 0.95)",
        backdropFilter: "blur(20px)",
        border: "1px solid rgba(255, 255, 255, 0.1)",
        width: "min(900px, 95vw)",
        maxHeight: isCollapsed ? "52px" : "280px",
      }}
    >
      {/* Header - Compact */}
      <div
      ...
      {/* Content - Horizontal Layout (collapsed 시 숨김) */}
      {!isCollapsed && (
